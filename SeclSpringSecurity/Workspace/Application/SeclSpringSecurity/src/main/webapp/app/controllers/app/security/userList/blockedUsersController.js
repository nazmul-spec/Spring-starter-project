...
define(['app'], function (app) {
	...
	var blockedUsersController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_BlockedUsers"};
		...
		$scope.unblock = function(user) {
			...
			var modalOptions = {
					...
					headerText: 'Unblock?',
					bodyText: 'Are you sure you want to unblock User ',
					data: user,
					id: user.loginId,
			...
			modalService.showModal(modalDefaults, modalOptions).then(function (result) { 
				...
				var blockObj = {
						operationType : constantService.UNBLOCK_USER_BY_LOGIN_ID,
						userBean : userObj					
				};
				
			    promis = userService.unblockUser(blockObj);
		...
		var getUserList = function () {
			...
			var blockObj = {
					operationType : constantService.GET_BLOCKED_USER_LIST,
					userBean : userObj					
			};
			promis = userService.blockedUserList(blockObj);
			promis.then(function (data) {
				ngProgress.complete();
	...
	app.register.controller('blockedUsersController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                                ...
	                                                'loadService', 'comboService', 'constantJSON', blockedUsersController]);
