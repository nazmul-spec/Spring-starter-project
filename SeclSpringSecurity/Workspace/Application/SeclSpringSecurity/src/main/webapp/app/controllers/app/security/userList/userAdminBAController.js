...
define(['app'], function (app) {
	...
	var userAdminBAController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_BranchUser_Admin_BA"};
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_BranchUser_Admin_BA' + '/' + constantService.Update + '/' + user.loginId);        
		};
		...
		var getUserList = function () {
			...
			if(userInfo.data.branchID != undefined && userInfo.data.branchID != null && userInfo.data.branchID != "")
			{
				...
				$scope.isFieldDisabledBranchID = false;
			var userObj = { 
					operationType : constantService.GET_USER_LIST_FOR_BA,
	...
	app.register.controller('userAdminBAController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userAdminBAController]);
