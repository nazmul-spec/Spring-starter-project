...
define(['app'], function (app) {
	...
	var userAdminOfficerBAController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_AdminOfficer_BA"};
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_AdminOfficer_BA' + '/' + constantService.Update + '/' + user.loginId);
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_AdminOfficer_BA' + '/' + constantService.Add + '/' + 'nan');
		};
	...
	app.register.controller('userAdminOfficerBAController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userAdminOfficerBAController]);
