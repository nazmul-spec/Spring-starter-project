...
define(['app'], function (app) {
	...
	var cbsAccountListMController = function ($rootScope, $scope, $timeout, $route, $filter,$http,  messageService, constantService, modalService,
			navigationService, localStorageService, configurationService, ngProgress,  constantJSON, loadService , ngTableParams) {
		
		var userInfo;
		$scope.title = {value: "CBS_AccountList_Make"};	
		var init = function(){
			ngProgress.start();
	   ...
	   var createTableParams = function(){		
	    ...
	    $scope.continueFileUpload=function (){
	    	//uploadFile
	    	var uploadUrl=configurationService.csbAccXlUpload;
	...
	app.register.controller('cbsAccountListMController', ['$rootScope', '$scope', '$timeout', '$route', '$filter','$http',  'messageService', 
	                                              'constantService', 'modalService', 'navigationService', 'localStorageService', 'configurationService', 
	                                              'ngProgress',  'constantJSON', 'loadService', 'ngTableParams', cbsAccountListMController]);
});
