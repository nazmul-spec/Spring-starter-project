...
define(['app'], function (app) {
	...
	var userManagerBMController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_Manager_BM"};
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_Manager_BM' + '/' + constantService.Update + '/' + user.loginId);        
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_Manager_BM' + '/' + constantService.Add + '/' + 'nan');
		};
	...
	app.register.controller('userManagerBMController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userManagerBMController]);
