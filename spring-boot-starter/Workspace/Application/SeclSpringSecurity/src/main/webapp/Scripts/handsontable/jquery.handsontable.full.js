...
Handsontable.TableView.prototype.appendColHeader = function (col, TH) {
  ...
  if (col > -1) {
    ...
    Handsontable.Dom.fastInnerText(SPAN, '#');// modified by nazmul....prev=Handsontable.Dom.fastInnerText(SPAN, '\u00A0')
  }
  DIV.appendChild(SPAN);
  ...
  var CheckboxRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
    ...
    if (value === cellProperties.checkedTemplate || value === Handsontable.helper.stringify(cellProperties.checkedTemplate)) {
      ...
      TD.appendChild(INPUT);
    	...
    	INPUT.checked = false;
        TD.appendChild(INPUT); //this is faster than innerHTML. See: https://github.com/handsontable/jquery-handsontable/wiki/JavaScript-&-DOM-performance-tips
    }
...
(function(Handsontable){
  ...
  TextEditor.prototype.createElements = function () {
    ...
    this.textareaStyle.width = 92;
    this.textareaStyle.height = 24;
