...
define(['app'], function (app) {
	...
	var calendarService =  function ($rootScope, $resource, $q, constantService , messageService, configurationService) {
		
	var saveResource, updateResource, getResource, delay, isValidForm,  get, save, update;
    
    
	saveResource = $resource(configurationService.calendarSave, {}, {
    	save : { method: 'POST' }
    });
	
	updateResource = $resource(configurationService.calendarUpdate, {}, {
    	update : { method: 'POST' }
    });
	
	getResource = $resource(configurationService.calendarGet, {}, {
    	get : { method: 'POST' }
    });
    ...
    return {
	 ...
	 app.service('calendarService', ['$rootScope', '$resource', '$q', 'constantService', 'messageService', 'configurationService', calendarService]);
