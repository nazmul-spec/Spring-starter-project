...
define(['app'], function (app) {
	...
	var userBMController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_BranchUser"};
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_BranchUser' + '/' + constantService.Update + '/' + user.loginId);        
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_BranchUser' + '/' + constantService.Add + '/' + 'nan');
		};
	...
	app.register.controller('userBMController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
