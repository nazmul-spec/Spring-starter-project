...
define(['app'], function (app) {
	...
	var userAdminOfficerBMController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_AdminOfficer_BM"};
		...
		$scope.roleList = [
		                   	{ key: "Admin.Maker", value: "Admin Maker" },
		                    { key: "Admin.Approver", value: "Admin Approver" }
		                  ];
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_AdminOfficer_BM' + '/' + constantService.Update + '/' + user.loginId);        
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_AdminOfficer_BM' + '/' + constantService.Add + '/' + 'nan');
		};
		...
		var getUserList = function () {
			...
			var userObj = { 
					operationType : constantService.GET_ADMIN_OFFICER_LIST_FOR_BM,
	...
	app.register.controller('userAdminOfficerBMController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userAdminOfficerBMController]);
