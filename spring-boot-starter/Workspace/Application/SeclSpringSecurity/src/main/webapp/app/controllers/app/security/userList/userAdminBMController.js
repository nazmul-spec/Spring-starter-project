...
define(['app'], function (app) {
	...
	var userAdminBMController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_BranchUser_Admin_BM"};
		...
		$scope.roleList = [{ key: 'Branch.OfficerMaker', 	value: 'Branch Officer Maker'},
		                   /*{ key: 'Branch.OfficerChecker', 	value: 'Branch Officer Checker'},*/
		                   { key: 'Branch.OfficerApprover', value: 'Branch Officer Approver'}];
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_BranchUser_Admin_BM' + '/' + constantService.Update + '/' + user.loginId);        
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_BranchUser_Admin_BM' + '/' + constantService.Add + '/' + 'nan');
		};
		...
		var getUserList = function () {
			...
			var userObj = { 
					operationType : constantService.GET_USER_LIST_FOR_BM,
					bankID : $scope.combo.bankID,
					branchID : $scope.combo.branchID,
					role: $scope.combo.role,
					makerID : userInfo.data.loginId,
	...
	app.register.controller('userAdminBMController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userAdminBMController]);
