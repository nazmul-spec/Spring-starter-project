...
define(['app'], function (app) {
	...
	var userABDbMController = function ($rootScope, $scope, $log, $filter, $timeout, $route, _,  messageService, 
		...
		$scope.title = {value: "Security_ABDUser_BM"};
		...
		$scope.roleList = [
		                   	{ key: "SD.Checker", value: "Service Delivery Checker" },
		...
		$scope.goForEdit = function(user) {
			navigationService.menuNavigation('Security_ABDUser_BM' + '/' + constantService.Update + '/' + user.loginId);        
		};
		//End Card View Edit Option

		$scope.goToNewUserPage = function() {
			navigationService.menuNavigation('Security_ABDUser_BM' + '/' + constantService.Add + '/' + 'nan');
		};
	...
	app.register.controller('userABDbMController', ['$rootScope', '$scope', '$log', '$filter', '$timeout', 
	                                             ...
	                                             'loadService', userABDbMController]);
